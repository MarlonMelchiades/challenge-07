...
body.innerHTML = `
  <header class="bg-dark text-center text-white" id="template-header">
    ...
    <div class="container p-4 pb-0">
      <section class="pb-4">
        <p>Eai, beleza?</br>Aqui vão alguns Challenges feitos por Marlon Melchiades, com JavaScript puro!</br>Foi muito divertido fazer eles! </br> Esse é o #07 de #10. Veja e se divirta também! (vai que você ache algo útil aqui pra você!) ㋡</p>
      </section>
    </div>
  </header>
  ` +
  '<main class="container" id="template-main">' +
    "<section>" + cardStep61 + "</section>" +
    "<section>" + cardStep62 + "</section>" +
    "<section>" + cardStep63 + "</section>" +
    "<section>" + cardStep64 + "</section>" +
    "<section>" + cardStep66 + "</section>" +
    "<section>" + cardStep67 + "</section>" +
    "<section>" + cardStep68 + "</section>" +
    "<section>" + cardStep69 + "</section>" +
    "<section>" + cardStep70 + "</section>" +
  '</main>'+`
